            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-6 text-lg/8 text-gray-600">
                        ...
                        accessible, open-source, and built with flexibility in
                        mind. If you don’t find what you’re looking for here,
                        feel free to reach out to our community or check the
                        documentation.
                    </p>
                </div>
                <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
                    <Accordion type="single" collapsible className="w-full">
                        ...
                        <AccordionItem value="item-2">
                            ...
                            <AccordionContent>
                                Absolutely. Aftermath Archive is designed for
                                self-hosting, giving you full control over your
                                data and deployment.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                            ...
                            <AccordionContent>
                                Yes, it’s fully open-source and free. You can
                                download, use, and modify it as you need.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-4">
                            ...
                            <AccordionContent>
                                Security is a priority. We follow best practices
                                for encryption, authentication, and secure data
                                handling.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value="item-6">
                            ...
                            <AccordionContent>
                                ...
                                community-driven. You can contribute or ask for
                                help on GitHub or community forums.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-7">
                            ...
                            <AccordionContent>
                                Yes, detailed documentation is provided to help
                                you deploy Aftermath Archive on your
                                infrastructure.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
